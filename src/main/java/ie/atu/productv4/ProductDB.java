...
public class ProductDB {
    ...
    public static Product getProduct(String productCode) {
        ...
        ie.atu.productv4.Book myBook = null;
        if (productCode.equalsIgnoreCase("java")) {
            myBook = new ie.atu.productv4.Book();
        ...
        ie.atu.productv4.Software mySoftware = null;
        if (productCode.equalsIgnoreCase("studios")) {
            mySoftware = new ie.atu.productv4.Software();
        ...
        if (productCode.equalsIgnoreCase("Juice")) {
            Music myMusic = new Music();
            myMusic.setCode(productCode);
            myMusic.setDescription("Man of the year");
            myMusic.setPrice(30.00);
            myMusic.setArtist("Juice Wrld");
            myMusic.setLabel("MTV");
            myProduct = myMusic;
        } else if (productCode.equalsIgnoreCase("Olivia")) {
            Music myMusic = new Music();
            myMusic.setCode(productCode);
            myMusic.setDescription("Vampire");
            myMusic.setPrice(6.50);
            myMusic.setArtist("Olivia Rodriga");
            myMusic.setLabel("MTV");
            myProduct = myMusic;
        } else if (productCode.equalsIgnoreCase("Red")) {
            Music myMusic = new Music();
            myMusic.setCode(productCode);
            myMusic.setDescription("Redrum");
            myMusic.setPrice(10.50);
            myMusic.setArtist("21");
            myMusic.setLabel("MTV");
            myProduct = myMusic;
        }
